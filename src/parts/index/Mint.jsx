  ...
  const mintButton = async () => {
          ...
          if (state === "1") {
                ...
                if (json) {
                  ...
                  if (found) {
                    var message = window.web3.utils.soliditySha3('0xCB8b11B351c785bc4C245F3c530ebA9771011202', accounts[0]);
                    ...
                    const gas_ = await contract.methods.presaleMint(amount, v, r, s).estimateGas({from: accounts[0], value: mint_fee * amount});
              ...
              const gas_ = await contract.methods.publicSaleMint(amount).estimateGas({ from: accounts[0], value: mint_fee * amount });
              //alert(gas)
              if (!gas_) {
                alert('Not enough funds');
                return
     ...
     const loadContract = async () => {
          ...
          ], '0xCB8b11B351c785bc4C245F3c530ebA9771011202');
     }
